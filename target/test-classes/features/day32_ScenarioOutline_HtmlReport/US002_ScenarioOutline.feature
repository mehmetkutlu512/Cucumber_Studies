...
Feature: US002_DataTables_Testi
  ...
  Background: https://editor.datatables.net sayfasinda veri girisi
  ...
  Scenario Outline: TC01_DataTablesda_Veri_Girisi
    ...
    When cikan_pencerede_verilen_bilgileri_girelim "<firstname>","<lastname>", "<position>", "<office>", "<extension>", "<date>", "<salary>"
